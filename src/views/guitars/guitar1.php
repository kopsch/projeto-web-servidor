...
<body>
    ...
    <div class="container">
        <div class="product">
            ...
            <p class="product-description"> Esta guitarra curta de alta qualidade apresenta um corpo sólido em mogno com acabamento em sunburst. Seu braço em maple proporciona conforto e agilidade ao tocar, enquanto os captadores de bobina única fornecem um som brilhante e articulado.

                *As medidas e as cores dos detalhes podem variar insignificativamente conforme os acabamentos utilizados
                em cada lote de produção.</p>
